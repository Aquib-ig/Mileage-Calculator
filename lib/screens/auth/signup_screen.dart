            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  AppButton(
                    // disable to the button when its loading
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Container(height: 45, width: 45, color: Colors.blue),
                      SizedBox(width: 10),
                      Container(height: 45, width: 45, color: Colors.red),
                      SizedBox(width: 10),
                      Container(height: 45, width: 45, color: Colors.yellow),
                      SizedBox(width: 10),
                      Container(height: 45, width: 45, color: Colors.green),
                    ],
                  ),
                  SizedBox(height: 20),
                  Row(
